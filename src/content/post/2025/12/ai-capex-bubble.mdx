...
I've spent this year building [Onix](https://www.onixai.ai/) with [David](https://www.linkedin.com/in/dbennahum/), watching the AI landscape shift beneath everyone's feet. And the more I look at the numbers driving this industry, the more convinced I am that we're watching one of the greatest misallocations of capital in tech history unfold in real time.

Here are two facts that should make you uncomfortable if you work in AI:

1. Hyperscalers will spend over **$400 billion** on AI infrastructure in 2025
2. The cost to run a frontier-quality AI model has dropped **280x** since November 2022

Read those again. One number is exploding. The other is collapsing. And somehow, the people spending the exploding number think they're building a moat.

They're not. They're building a monument to sunk cost fallacy.
...
The recovery that followed—NVIDIA eventually hitting $5 trillion by October—doesn't change the lesson. It just shows how much the market wants to believe the old story.
...
**Latency.** You can't beat physics. A model running on-device will always be faster than a round-trip to a data center. For real-time applications—robotics, autonomous systems, interactive agents—this isn't a nice-to-have. It's table stakes.
...
We looked at the same data I've shared in this post and saw something different. We saw a window.
...
The real opportunity is in the gap between their spending and the collapsing costs. Every dollar they pour into centralized infrastructure is a dollar that becomes less valuable as inference costs drop another 10x.
